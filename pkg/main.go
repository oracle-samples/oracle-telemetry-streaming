...
func main() {
	...
	// be called and new datasource instance created using NewOracleDatasource
	// factory.
	if err := datasource.Manage("grafana-oracle-datasource",
		plugin.NewOracleDatasource, datasource.ManageOpts{}); err != nil {
