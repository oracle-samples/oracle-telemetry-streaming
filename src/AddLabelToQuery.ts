...
// Safari currently doesn't support negative lookbehind. When it does, we should
// refactor this.
// We are creating 2 matching groups. (\$) is for the Grafana's variables such
// as ${__rate_s}. We want to ignore ${__rate_s} and not add variable to it.
